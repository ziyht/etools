...
static natsStatus
_makeTLSConn(natsConnection *nc __unused)
{
...
static void
_processPingTimer(natsTimer *timer __unused, void *arg)
{
    natsConnection  *nc = (natsConnection*) arg;
...
static void
_pingStopppedCb(natsTimer *timer __unused, void *closure)
{
...
void
natsConn_processOK(natsConnection *nc __unused)
{
    // Do nothing for now.
}
