...
typedef struct _eskiplist_link_s{
    _esln       forward[1];             // forward's real cnt is alloc dynamiclly
    _esln       backward;
    int         level;
}_esll_t, * _esll;
...
uint esl_len(esl l) { return l ? _eo_len(l) : 0; }
...
eobj   esl_addR(esl l, ekey key, size   len) { _esln_t b = { { {0} , 0, 0}, key, {._len =                   len + 1, ._typ = {.t_coe = _ESL_COE_RAW_P}}, {             0} }; eobj o = __esl_makeRoom(l, _vn_o(&b), 0, 0, 0); if(o){                _eo_wipeR(o, len             ); _eo_typeco(o)  = _EDICT_CO_RAW   ; } return o; }
...
eobj   esl_addMR(esl l, ekey key, size   len){ _esln_t b = { { {0} , 0, 0}, key, {._len =                   len + 1, ._typ = {.t_coe = _ESL_COE_RAW_P}}, {             0} }; eobj o = __esl_makeRoom(l, _vn_o(&b), 1, 0, 0); if(o){                _eo_wipeR(o, len             ); _eo_typeco(o)  = _EDICT_CO_RAW   ; } return o; }
...
eobj   esl_val (esl l, ekey key) { return esl_find(l, key); }
i64    esl_valI(esl l, ekey key) { eobj o = esl_find(l, key); _eo_retI(o); }
f64    esl_valF(esl l, ekey key) { eobj o = esl_find(l, key); _eo_retF(o); }
cstr   esl_valS(esl l, ekey key) { eobj o = esl_find(l, key); _eo_retS(o); }
cptr   esl_valR(esl l, ekey key) { eobj o = esl_find(l, key); _eo_retR(o); }
cptr   esl_valP(esl l, ekey key) { eobj o = esl_find(l, key); _eo_retP(o); }

etypeo esl_valType  (esl l, ekey key) { eobj o = esl_find(l, key); _eo_retT(o); }
uint   esl_valLen   (esl l, ekey key) { eobj o = esl_find(l, key); _eo_retL(o); }
bool   esl_valIsTrue(esl l, ekey key) { return __eobj_isTrue(esl_find(l, key)); }
...
int  esl_freeO  (esl l, eobj   o){      o = esl_takeO  (l,   o); if(o){ if(_c_rls(l)) _c_rls(l)(o, _c_prvt(l)); if(_c_keys(l)) _eo_freeK(o);  _vn_free(_o_vn(o)); return 1; } return 0; }
