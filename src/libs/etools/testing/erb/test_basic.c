...
int erb_val_test()
{
...

    {
        ...
        eexpect_num(erb_len(h), 5);

        /// -- test 1
        i = 1;
        o = erb_val(h, ekey_i(i));
        ...
        i = 1;
        eexpect_num(eobj_typeo(erb_val(h, ekey_i(i))), ENUM);
        eexpect_num(erb_valI(h, ekey_i(i)), 1);
        eexpect_num(erb_valF(h, ekey_i(i)), 1.0);

        i = 2;
        eexpect_num(eobj_typeo(erb_val(h, ekey_i(i))), ENUM);
        eexpect_num(erb_valI(h, ekey_i(i)), 2);
        eexpect_num(erb_valF(h, ekey_i(i)), 2.0);

        i = 3;
        eexpect_num(eobj_typeo(erb_val(h, ekey_i(i))), EPTR);
        eexpect_ptr(erb_valP(h, ekey_i(i)), (cptr)3);

        i = 4;
        eexpect_num(eobj_typeo(erb_val(h, ekey_i(i))), ESTR);
        eexpect_str(erb_valS(h, ekey_i(i)), "4");

        i = 5;
        eexpect_num(eobj_typeo(erb_val(h, ekey_i(i))), ERAW);
        eexpect_raw(erb_valR(h, ekey_i(i)), "\0\0\0\0\0", 5);
        ...
        for(i = 0; i < 100; i++)
        {
            eexpect_num(erb_valI(h, ekey_i(i)), i);
        }
    }

    {
        ...
        /// -- test 2
        i = 1;
        eexpect_num(eobj_typeo(erb_val(h, ekey_s(&key[i]))), ENUM);
        eexpect_num(erb_valI(h, ekey_s(&key[i])), 1);
        eexpect_num(erb_valF(h, ekey_s(&key[i])), 1.0);

        i = 2;
        eexpect_num(eobj_typeo(erb_val(h, ekey_s(&key[i]))), ENUM);
        eexpect_num(erb_valI(h, ekey_s(&key[i])), 2);
        eexpect_num(erb_valF(h, ekey_s(&key[i])), 2.0);

        i = 3;
        eexpect_num(eobj_typeo(erb_val(h, ekey_s(&key[i]))), EPTR);
        eexpect_ptr(erb_valP(h, ekey_s(&key[i])), (cptr)3);
        i = 4;
        eexpect_num(eobj_typeo(erb_val(h, ekey_s(&key[i]))), ESTR);
        eexpect_str(erb_valS(h, ekey_s(&key[i])), "4");

        i = 5;
        eexpect_num(eobj_typeo(erb_val(h, ekey_s(&key[i]))), ERAW);
        eexpect_raw(erb_valR(h, ekey_s(&key[i])), "\0\0\0\0\0", 5);
        ...
        {
            sprintf(key, "%d", i);
            eexpect_num(erb_valI(h, ekey_s(key)), i);
        }
    }
...
int erb_itr_test()
{
...

    {
        ...
        eexpect_num(erb_len(h), 200);

        i = 0;
        erb_foreach(h, itr)
        {
            sprintf(buf, "%"PRId64"", i+100000000000);
            eexpect_str(erb_valS(h, ekey_i(i)), buf);
...

    {
        ...
        erb_foreach(h, itr)
        {
            sprintf(key, "%04d", i);
            sprintf(buf, "%"PRId64"", i+100000000000);
            eexpect_str(erb_valS(h, ekey_s(key)), buf);
            eexpect_str(eobj_valS(itr), buf);
            i++;
        }
    }
...
int erb_take_test()
{
...

    {
        ...
        while(erb_len(h))
        {
            ...
            erb_foreach(h, itr)
            {
                eexpect_ptr(erb_val(h, eobj_key(itr)), itr);
            }
        }
    }
