...
static int __obj_check(ejson r)
{
    ...
    e = ejson_k(r, "false" ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EFALSE);
    e = ejson_k(r, "true"  ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), ETRUE);
    e = ejson_k(r, "null"  ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), ENULL);
    e = ejson_k(r, "int"   ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), ENUM);  eexpect_num(eobj_valI(e), 100);
    e = ejson_k(r, "double"); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), ENUM);  eexpect_num(eobj_valF(e), 100.123);
    e = ejson_k(r, "str"   ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), ESTR);  eexpect_str(eobj_valS(e), "str");
    e = ejson_k(r, "arr"   ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EARR);  eexpect_num(eobj_len(e), 8);
    e = ejson_k(r, "obj"   ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EOBJ);  eexpect_num(eobj_len(e), 8);
