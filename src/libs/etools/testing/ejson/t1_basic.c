...
static int ejson_add_test1()
{
    ...
    o = ejson_k(r, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EFALSE); eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));

    ++i;
    o = ejson_k(r, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ETRUE) ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));

    ++i;
    o = ejson_k(r, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ENULL) ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));

    ++i;
    o = ejson_k(r, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ENUM)  ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));
    eexpect_num(eobj_valI(o), 1)      ; eexpect_num(ejson_kvalI(   r, &key[i]), eobj_valI( o));
    eexpect_num(eobj_valF(o), 1.0)    ; eexpect_num(ejson_kvalF(   r, &key[i]), eobj_valF( o));

    ++i;
    o = ejson_k(r, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ENUM)  ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));
    eexpect_num(eobj_valI(o), 2)      ; eexpect_num(ejson_kvalI(   r, &key[i]), eobj_valI( o));
    eexpect_num(eobj_valF(o), 2.0)    ; eexpect_num(ejson_kvalF(   r, &key[i]), eobj_valF( o));

    ++i;
    o = ejson_k(r, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ESTR)  ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));
    eexpect_str(eobj_valS(o), &key[i]); eexpect_str(ejson_kvalS(   r, &key[i]), eobj_valS( o));

    ++i;
    o = ejson_k(r, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EPTR)  ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));
    eexpect_ptr(eobj_valP(o), &key[i]); eexpect_ptr(ejson_kvalP(   r, &key[i]), eobj_valP( o));

    ++i;
    o = ejson_k(r, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ERAW)  ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));
    eexpect_num(eobj_len(o)  , 9   )  ; eexpect_num(ejson_klen( r, &key[i]), eobj_len(  o));
    eexpect_raw(eobj_valR(o) , zero, 9); eexpect_raw(ejson_kvalR(  r, &key[i]), eobj_valR( o), 9);

    ++i;
    o = ejson_k(r, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EOBJ)  ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));
    eexpect_num(eobj_len(o)  , 0   )  ; eexpect_num(ejson_klen( r, &key[i]), eobj_len(  o));

    ++i;
    o = ejson_k(r, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EARR)  ; eexpect_num(ejson_ktype(r, &key[i]), ejson_type(o));
    eexpect_num(eobj_len(o)  , 0   )  ; eexpect_num(ejson_klen( r, &key[i]), eobj_len(  o));
...
#define RKEY KEY1"."KEY2
    ...
    i = -1;
    i++; ejson_kaddT(r, RKEY, &key[i], EFALSE);
    i++; ejson_kaddT(r, RKEY, &key[i], ETRUE);
    i++; ejson_kaddT(r, RKEY, &key[i], ENULL);
    i++; ejson_kaddI(r, RKEY, &key[i], 1);
    i++; ejson_kaddF(r, RKEY, &key[i], 2.0);
    i++; ejson_kaddS(r, RKEY, &key[i], &key[i]);
    i++; ejson_kaddP(r, RKEY, &key[i], &key[i]);
    i++; ejson_kaddR(r, RKEY, &key[i], 9);
    i++; ejson_kaddT(r, RKEY, &key[i], EOBJ);
    i++; ejson_kaddT(r, RKEY, &key[i], EARR);
    ...
    o = ejson_k(e, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EFALSE); eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));

    ++i;
    o = ejson_k(e, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ETRUE) ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));

    ++i;
    o = ejson_k(e, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ENULL) ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));

    ++i;
    o = ejson_k(e, &key[i]);
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ENUM)  ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));
    eexpect_num(eobj_valI(o), 1)      ; eexpect_num(ejson_kvalI(   e, &key[i]), eobj_valI( o));
    eexpect_num(eobj_valF(o), 1.0)    ; eexpect_num(ejson_kvalF(   e, &key[i]), eobj_valF( o));

    ++i;
    o = ejson_k(e, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ENUM)  ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));
    eexpect_num(eobj_valI(o), 2)      ; eexpect_num(ejson_kvalI(   e, &key[i]), eobj_valI( o));
    eexpect_num(eobj_valF(o), 2.0)    ; eexpect_num(ejson_kvalF(   e, &key[i]), eobj_valF( o));

    ++i;
    o = ejson_k(e, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ESTR)  ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));
    eexpect_str(eobj_valS(o), &key[i]); eexpect_str(ejson_kvalS(   e, &key[i]), eobj_valS( o));

    ++i;
    o = ejson_k(e, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EPTR)  ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));
    eexpect_ptr(eobj_valP(o), &key[i]); eexpect_ptr(ejson_kvalP(   e, &key[i]), eobj_valP( o));

    ++i;
    o = ejson_k(e, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), ERAW)  ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));
    eexpect_num(eobj_len(o)  , 9   )  ; eexpect_num(ejson_klen( e, &key[i]), eobj_len(  o));
    eexpect_raw(eobj_valR(o) , zero, 9); eexpect_raw(ejson_kvalR(  e, &key[i]), eobj_valR( o), 9);

    ++i;
    o = ejson_k(e, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EOBJ)  ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));
    eexpect_num(eobj_len(o)  , 0   )  ; eexpect_num(ejson_klen( e, &key[i]), eobj_len(  o));

    ++i;
    o = ejson_k(e, &key[i])        ;
    eunexpc_ptr(o, 0);
    eexpect_num(ejson_type(o), EARR)  ; eexpect_num(ejson_ktype(e, &key[i]), ejson_type(o));
    eexpect_num(eobj_len(o)  , 0   )  ; eexpect_num(ejson_klen( e, &key[i]), eobj_len(  o));
...
static int ejson_addJ_test()
{
    ...
    i++; ejson_addJ(r, 0, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, 0, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, 0, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, 0, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, 0, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    ...
    r = ejson_new(EOBJ, 0); i = -1;
    i++; ejson_addJ(r, map[i].key, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, map[i].key, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, map[i].key, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, map[i].key, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
    i++; ejson_addJ(r, map[i].key, map[i].json); eexpect_num(ejson_len(r), i + 1); eexpect_num(ejson_ktype(r, map[i].key), map[i].t );
...
#define RKEY KEY1"."KEY2
    ...
    i = -1;
    i++; ejson_kaddJ(r, RKEY, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    ...
    i = -1;
    i++; ejson_kaddJ(r, RKEY, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_kaddJ(r, RKEY, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
...
#define KEYS KEY1"."KEY2
    ...
    i = -1;
    i++; ejson_paddJ(r, KEYS, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, 0, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    ...
    i = -1;
    i++; ejson_paddJ(r, KEYS, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
    i++; ejson_paddJ(r, KEYS, map[i].key, map[i].json); eexpect_num(ejson_len(e), i + 1); eexpect_num(ejson_ktype(e, map[i].key), map[i].t );
