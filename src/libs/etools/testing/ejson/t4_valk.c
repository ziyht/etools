...
static int t4_valk_case1()
{
    ...
    e = ejson_valk(r, "1"             ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EOBJ);
    e = ejson_valk(r, "1.2"           ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EOBJ);
    e = ejson_valk(r, "1.2.3"         ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EARR);
    e = ejson_valk(r, "1.2.3[0]"      ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EARR);
    e = ejson_valk(r, "1.2.3[0][0]"   ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EARR);
    e = ejson_valk(r, "1.2.3[0][0][0]"); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), ESTR);
    e = ejson_valk(r, "1.2.3[0][1]"   ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), EOBJ);
    e = ejson_valk(r, "1.2.3[0][1].4" ); eunexpc_ptr(e, 0); eexpect_num(ejson_type(e), ESTR);
